...
<div class="event" style="border: #02DFEF 1px solid">
    <div class="title">
   <img src="<?php echo esc_url( $event['logo']['url'] );?>" class="logo" alt="<?php echo esc_attr( $event['logo']['alt'] ); ?>">
   <h3 style="color:#02DFEF;"><?php echo $event["name"] ?></h3>
    </div>
...
<div class="joinvertex">
    <button class="joinvertex-button" onclick="window.open('<?php echo $event["tickets"]; ?>', '_blank')">
        JOIN EVENT
    </button>
</div>
<?php endforeach; ?>